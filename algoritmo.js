...
//Realizar un algoritmo que sume 3 productos del supermercado con precios ingresados y me de el valor total mas el iva de 19%
function iva() {
    precioProducto1 = parseFloat(prompt("Ingrese el precio del primer producto:"));
    precioProducto2 = parseFloat(prompt("Ingrese el precio del segundo producto:"));
    precioProducto3 = parseFloat(prompt("Ingrese el precio del tercer producto:"));

    totalSinIVA = precioProducto1 + precioProducto2 + precioProducto3;
    iva = 0.19;
...
function loteria() {
    ...
    if (numeroElegido < 1 || numeroElegido > 10) {
        ...
        console.log("¡Ganaste! El número ganador era " + numeroGanador);
        alert("¡Ganaste! El número ganador era " + numeroGanador);
    } else {
        console.log("Perdiste. El número ganador era " + numeroGanador);
        alert("Perdiste. El número ganador era " + numeroGanador);
    }
}